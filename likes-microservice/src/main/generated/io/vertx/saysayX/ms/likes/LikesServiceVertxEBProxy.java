...
public class LikesServiceVertxEBProxy implements LikesService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public LikesServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public LikesServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  LikesService addLikes(LikesBean Likes, Handler<AsyncResult<Integer>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("Likes", Likes == null ? null : Likes.toJson());

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addLikes");
  ...
  public  LikesService retrieveLikes(String id, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveLikes");
  ...
  public  LikesService retrieveLikesByAuthorId(String authorId, Handler<AsyncResult<List<JsonObject>>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveLikesByAuthorId");
  ...
  public  LikesService updateLikes(LikesBean Likes, Handler<AsyncResult<Integer>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "updateLikes");
    _vertx.eventBus().<Integer>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  LikesService deleteLikes(String id, Handler<AsyncResult<Integer>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteLikes");
    _vertx.eventBus().<Integer>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
