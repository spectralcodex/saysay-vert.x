  ...
  */
  var AdministrationService = function(eb, address) {
    ...
    /**
     ...
     @return {AdministrationService}
     */
    this.addUserByEmail =  function(user, resultHandler) {
      var __args = arguments;
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        if (closed) {
          throw new Error('Proxy is closed');
        }
        j_eb.send(j_address, {"user":__args[0]}, {"action":"addUserByEmail"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.updateUser =  function(user, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"user":__args[0]}, {"action":"updateUser"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.addCompany =  function(company, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"company":__args[0]}, {"action":"addCompany"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.activateCompany =  function(companyId, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"companyId":__args[0]}, {"action":"activateCompany"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.updateCompanyById =  function(company, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"company":__args[0]}, {"action":"updateCompanyById"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveAllCompany =  function(resultHandler) {
      ...
      if (__args.length === 1 && typeof __args[0] === 'function') {
        ...
        j_eb.send(j_address, {}, {"action":"retrieveAllCompany"}, function(err, result) { __args[0](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.addInterest =  function(interestId, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"interestId":__args[0]}, {"action":"addInterest"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveInterestId =  function(interestId, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"interestId":__args[0]}, {"action":"retrieveInterestId"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.deleteInterest =  function(interestId, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"interestId":__args[0]}, {"action":"deleteInterest"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.activateInterest =  function(interestId, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"interestId":__args[0]}, {"action":"activateInterest"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.updateInterestById =  function(interest, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"interest":__args[0]}, {"action":"updateInterestById"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveAllInterest =  function(resultHandler) {
      ...
      if (__args.length === 1 && typeof __args[0] === 'function') {
        ...
        j_eb.send(j_address, {}, {"action":"retrieveAllInterest"}, function(err, result) { __args[0](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
