...
public class CommentServiceVertxEBProxy implements CommentService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CommentServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CommentServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  CommentService addComment(CommentBean Comment, Handler<AsyncResult<Integer>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("Comment", Comment == null ? null : Comment.toJson());
  ...
  public  CommentService retrieveComment(String id, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveComment");
  ...
  public  CommentService retrieveCommentByAuthorId(String authorId, Handler<AsyncResult<List<JsonObject>>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveCommentByAuthorId");
  ...
  public  CommentService updateComment(CommentBean Comment, Handler<AsyncResult<Integer>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "updateComment");
    _vertx.eventBus().<Integer>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  CommentService deleteComment(String id, Handler<AsyncResult<Integer>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteComment");
    _vertx.eventBus().<Integer>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
