...
export default class CommentService {
  ...
  init(resultHandler: (err: any, result: any) => any) : CommentService;

  addComment(Comment: any, resultHandler: (err: any, result: any) => any) : CommentService;

  retrieveComment(id: string, resultHandler: (err: any, result: Object) => any) : CommentService;
  ...
  deleteComment(id: string, resultHandler: (err: any, result: any) => any) : CommentService;
}