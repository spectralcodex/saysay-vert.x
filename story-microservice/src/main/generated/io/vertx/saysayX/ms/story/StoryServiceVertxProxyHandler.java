...
public class StoryServiceVertxProxyHandler extends ProxyHandler {
  ...
  public StoryServiceVertxProxyHandler(Vertx vertx, StoryService service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public StoryServiceVertxProxyHandler(Vertx vertx, StoryService service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public StoryServiceVertxProxyHandler(Vertx vertx, StoryService service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "retrieveStory": {
          service.retrieveStory((java.lang.String)json.getValue("id"),
                        HelperUtils.createHandler(msg));
          break;
        }
