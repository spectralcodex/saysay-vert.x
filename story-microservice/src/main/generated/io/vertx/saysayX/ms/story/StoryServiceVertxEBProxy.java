...
public class StoryServiceVertxEBProxy implements StoryService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public StoryServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public StoryServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  StoryService addStory(StoryBean story, Handler<AsyncResult<Integer>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("story", story == null ? null : story.toJson());

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addStory");
  ...
  public  StoryService retrieveStory(String id, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveStory");
